...
for port, desc, hwid in sorted(ports):
    print(hwid)
    if "{00001101-0000-1000-8000-00805F9B34FB}_LOCALMFG&005D" in hwid:
        btport = port



ser = serial.Serial(btport, 9600)
print("Connecting to "+btport)
# while True:
#     cc = str(ser.readline())
#     print(cc[2:][:-5])
...
cors = CORS(app, resources={r"/start_anim/*": {"origins": "*"}})
...
if __name__ == '__main__':
    ...
    t1 = threading.Thread(target=readBt)
    t1.daemon = True
    t1.start()
